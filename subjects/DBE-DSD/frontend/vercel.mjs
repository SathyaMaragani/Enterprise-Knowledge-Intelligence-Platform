...
// Render backend named by BACKEND_URL (set in the Vercel project's environment
...
export function createConfig(backendUrl) {
  if (!backendUrl) {
    throw new Error('Set BACKEND_URL in the Vercel project, e.g. https://eip-backend.onrender.com');
  }
